...
namespace LightSwitch {
 ...
 sealed class MainWindow : Form {
  ...
  protected override void OnPaint(PaintEventArgs e){
   ...
   Draw(g,"v1.0",new Font("Segoe UI",11,FontStyle.Regular,GraphicsUnit.Pixel),Palette.Muted,578,454);
  }
  ...
  void Apply(string mode){
   if(busy)return;busy=true;failed=false;on.Enabled=off.Enabled=false;status="Connecting to Alienware Command Center...";subtitle="AWCC may open while your lighting changes.";Invalidate();
